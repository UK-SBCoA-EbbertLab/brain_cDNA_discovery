...
database.db-path=/scratch/bjwh228/fragpipe/2023-06-20-decoys-contam-peptide_database_uniprot_header_run_MEDIAN_cpm_greater_than_one.fa.fas
...
fragpipe-config.bin-ionquant=/scratch/bjwh228/fragpipe/tools/IonQuant-1.9.8.jar
fragpipe-config.bin-msfragger=/scratch/bjwh228/fragpipe/tools/MSFragger-3.8/MSFragger-3.8.jar
fragpipe-config.bin-philosopher=/scratch/bjwh228/fragpipe/tools/philosopher_v5.0.0_linux_amd64/philosopher
fragpipe-config.bin-python=/share/apps/amd/conda/envs/python-3.9.6/bin/python3.9
freequant.mz-tol=10
...
msfragger.fragment_mass_tolerance=300
...
workdir=/scratch/bjwh228/results_FDR_10%_removed_files
