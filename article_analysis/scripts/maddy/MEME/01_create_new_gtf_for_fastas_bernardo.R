...
gtf_new_from_mito <- read_tsv("../../../data/maddy/MEME/new_exons_from_new_transcripts_mitochondrial_genes_filtered.tsv", col_types = "cccddccciic")
...
gtf_new_from_mito <- separate_info(gtf_new_from_mito, "../../../data/maddy/MEME/five_prime_splice_sites_nfm_12s_filtered.bed", "../../../data/maddy/MEME/three_prime_splice_sites_nfm_12s_filtered.bed", "../../../data/maddy/MEME/exons_nfm_12s_filtered.bed")
