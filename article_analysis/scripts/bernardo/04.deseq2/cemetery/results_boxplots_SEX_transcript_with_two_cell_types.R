...
converter = read.csv("../../../data/bernardo/processed/04.deseq2/transcript_results_converter_SEX_two.tsv", sep="\t")
...
# PDF device
pdf("../../../figures/bernardo/04.deseq2/results_SEX_boxplots_transcript_level_with_two_cell_types.pdf")
