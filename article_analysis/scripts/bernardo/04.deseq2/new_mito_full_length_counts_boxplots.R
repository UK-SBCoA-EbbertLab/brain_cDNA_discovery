...
cts <- as.matrix(read.csv("../../../data/bernardo/processed/04.deseq2/new_mito_full_length.tsv", sep="\t", row.names="transcript_id"))
...
# PDF device
pdf("../../../figures/bernardo/04.deseq2/new_mito_full_length_boxplots.pdf")
