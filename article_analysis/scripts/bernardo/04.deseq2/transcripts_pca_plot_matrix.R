...
pdf("../../../figures/bernardo/02.quality_control/pca_scree_plot_transcript.pdf", bg="transparent", width=(2.252*2.1), height=2.559)
...
pdf("../../../figures/bernardo/02.quality_control/PCA_plots_all_pcs_transcript.pdf", bg="transparent", width=2.252, height=2.559)
