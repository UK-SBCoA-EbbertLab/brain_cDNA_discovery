...
write.table(res, file = "../../../data/bernardo/processed/04.deseq2/multiple_transcripts_results_AD_vs_CT_with_covariate_four_cell_types.tsv", sep="\t")
write.table(res_med, file =  "../../../data/bernardo/processed/04.deseq2/multiple_transcripts_results_med_relevant_AD_vs_CT_with_covariate_four_cell_types.tsv", sep="\t")
