...
gene <- read.csv(file = '../../../data/bernardo/processed/04.deseq2/genes_annotated_results_M_vs_F_no_intron.tsv', sep="\t") 
...
# PDF device
pdf("../../../figures/bernardo/04.deseq2/volcano_plot_SEX_no_intron.pdf")
