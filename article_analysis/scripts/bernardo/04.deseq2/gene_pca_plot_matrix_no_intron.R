...
cts <- as.matrix(read.csv("../../../data/bernardo/processed/04.deseq2/gene_counts_unfiltered_no_introns.tsv", sep="\t", row.names="gene_id"))
...
pdf("../../../figures/bernardo/02.quality_control/pca_scree_plot_gene_no_intron.pdf", bg="transparent", width=(2.252*2.1), height=2.559)
...
pdf("../../../figures/bernardo/02.quality_control/PCA_plots_all_pcs_gene_no_intron.pdf", bg="transparent", width=2.252, height=2.559)
