...
# PDF device
pdf("../../../figures/bernardo/04.deseq2/results_SEX_boxplots_transcript_level.pdf")

for (transcript_id in converter$transcript_id) {

    d = plotCounts(dds, gene=transcript_id, intgroup="sex", returnData=TRUE, normalized=FALSE)
