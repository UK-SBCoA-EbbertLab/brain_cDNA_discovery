...
cts <- as.matrix(read.csv("../../data/processed/deseq2/gene_counts_unfiltered_no_introns.tsv", sep="\t", row.names="gene_id"))
...
pdf("../../figures/1st_rebuttal_figures/pca_plots/pca_scree_plot_gene_no_intron.pdf", bg="transparent", width=(2.252*2.1), height=2.559)
...
pdf("../../figures/1st_rebuttal_figures/pca_plots/PCA_plots_all_pcs_gene_no_intron.pdf", bg="transparent", width=2.252, height=2.559)
