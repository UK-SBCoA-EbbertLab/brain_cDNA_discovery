...
cts <- as.matrix(read.csv("../../data/processed/deseq2/transcript_counts_unfiltered.tsv", sep="\t", row.names="transcript_id"))
...
pdf("../../figures/1st_rebuttal_figures/pca_plots/pca_scree_plot_transcript.pdf", bg="transparent", width=(2.252*2.1), height=2.559)
...
pdf("../../figures/1st_rebuttal_figures/pca_plots/PCA_plots_all_pcs_transcript.pdf", bg="transparent", width=2.252, height=2.559)
