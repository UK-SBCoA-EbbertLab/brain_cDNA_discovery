...
converter = read.csv("../../../data/bernardo/processed/04.deseq2/gene_results_converter_AD_two.tsv", sep="\t")
...
# PDF device
pdf("../../../figures/bernardo/04.deseq2/results_AD_boxplots_gene_level_two.pdf")
