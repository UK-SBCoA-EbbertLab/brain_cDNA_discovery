...
cts_gene <- as.matrix(read.csv("../../../data/bernardo/processed/04.deseq2/gene_counts_unfiltered_no_introns.tsv", sep="\t", row.names="gene_id"))
...
converter = read.csv("../../../data/bernardo/processed/04.deseq2/transcript_results_converter_SEX.tsv", sep="\t")
...
# PDF device
pdf("../../../figures/bernardo/04.deseq2/results_SEX_boxplots_transcript_level_no_intron.pdf")
