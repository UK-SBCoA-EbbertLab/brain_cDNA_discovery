...
singularity exec ../../../../singularity_containers/bernardo_article_analysis.sif bedtools getfasta -fi ../../../references/bernardo/Homo_sapiens.GRCh38_ERCC.fa -bed ../../../data/maddy/MEME/five_prime_splice_sites_nfm_12s.bed -s -name -fo ../../../data/maddy/MEME/five_prime_splice_sites_nfm_12s_6_15_23.fa
singularity exec ../../../../singularity_containers/bernardo_article_analysis.sif bedtools getfasta -fi ../../../references/bernardo/Homo_sapiens.GRCh38_ERCC.fa -bed ../../../data/maddy/MEME/three_prime_splice_sites_nfm_12s.bed -s -name -fo ../../../data/maddy/MEME/three_prime_splice_sites_nfm_12s_6_15_23.fa
singularity exec ../../../../singularity_containers/bernardo_article_analysis.sif bedtools getfasta -fi ../../../references/bernardo/Homo_sapiens.GRCh38_ERCC.fa -bed ../../../data/maddy/MEME/exons_nfm_12s.bed -s -name -fo ../../../data/maddy/MEME/exons_nfm_12s_6_15_23.fa
